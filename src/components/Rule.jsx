...
export default function Rule() {
  return (
      <section className="flex md:flex-row-reverse flex-col border-b border-[#fff]/20 justify-between items-center gap-x-[80px] gap-y-[20px] lg:px-28 px-20 lg:py-0 py-5 w-full">
