...
export default function Privacy() {
  return (
    <section className="font-monts flex lg:flex-row flex-col items-center border-t border-[#fff]/20 justify-between lg:py-20 md:py-16 py-14 lg:pl-32 md:px-10 px-4 w-full gap-y-36 gap-x-[100px]">
